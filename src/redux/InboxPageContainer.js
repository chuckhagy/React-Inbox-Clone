...
function mapDispatchToProps(dispatch) {
  return {
    ...
    onMarkAsReadMessage: messageId =>
      dispatch(markAsReadMessageProcess(messageId)),
    ...
    onSelectMessage: messageId =>
      dispatch({ type: "SELECT_MESSAGE", messageId: messageId }),
    onDeselectMessage: messageId =>
      dispatch({ type: "DESELECT_MESSAGE", messageId: messageId }),
    ...
    onMarkAsUnreadSelectedMessages: () =>
      dispatch(markAsUnreadSelectedMessagesProcess()),
    onMarkAsReadSelectedMessages: () =>
      dispatch(markAsReadSelectedMessagesProcess()),
    onApplyLabelSelectedMessages: label =>
      dispatch(applyLabelSelectedMessagesProcess(label)),
    onRemoveLabelSelectedMessages: label =>
      dispatch(removeLabelSelectedMessagesProcess(label)),
